...
from PyQt6.QtWidgets import (QApplication, QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, 
                             ...
                             QFormLayout, QScrollArea, QMessageBox, QSplitter)
...
class RecoilSettingsTool(QMainWindow):
    ...
    def load_data(self):
        try:
            ...
            QMessageBox.critical(self, "Lỗi nạp dữ liệu", f"Không thể đọc ClassBaseRecoil.py: {e}")
            sys.exit(1)
    ...
    def init_ui(self):
        ...
        save_btn.setStyleSheet("background-color: #2ecc71; color: white; font-weight: bold; font-size: 14px;")
    ...
    def filter_weapons(self, text):
        ...
        filtered = [w for w in sorted(self.working_weapons.keys()) if text.upper() in w.upper()]
    ...
    def load_weapon_settings(self, index):
        ...
        for stance in ["Stand", "Crouch", "Prone"]:
            ...
            input_field.textChanged.connect(lambda text, w=weapon_name, s=stance: self.update_stance_map(w, s, text))
    ...
    def save_and_apply(self):
        try:
            ...
            output += '    scope_multipliers = ' + fmt_dict(self.working_scopes) + '\n\n'
