import importlib
import re
from .ClassBaseRecoil import BaseRecoilData
...
class RecoilConfig:
    ...
    def get_master_multiplier(self, gun_data):
        ...
        try:
            ...
            if w_name not in weapons_dict: return 1.0
    ...
    def get_all_stance_multipliers(self, w_name):
        ...
        try:
            ...
            if w_key not in weapons_dict: return {"Stand": 1.25, "Crouch": 1.0, "Prone": 0.7}
    ...
    def get_base_table(self, w_name):
        ...
        try:
            weapons_dict = getattr(self.data, "Weapons", {})
            w_key = w_name if w_name in weapons_dict else w_name.upper()
            if w_key not in weapons_dict: return []
